...
*/
 ...
 std::array<std::tuple<S,Cast,size_t,std::string>,104> module = {{      // module sym -> enum, pytorch name
  std::make_tuple(cs("adaptavg1d"),       Cast::adaptavg1d,      typeid(torch::nn::AdaptiveAvgPool1d).hash_code(),       "torch.nn.AdaptiveAvgPool1d"),
  std::make_tuple(cs("adaptavg2d"),       Cast::adaptavg2d,      typeid(torch::nn::AdaptiveAvgPool2d).hash_code(),       "torch.nn.AdaptiveAvgPool2d"),
  std::make_tuple(cs("adaptavg3d"),       Cast::adaptavg3d,      typeid(torch::nn::AdaptiveAvgPool3d).hash_code(),       "torch.nn.AdaptiveAvgPool3d"),
  std::make_tuple(cs("adaptmax1d"),       Cast::adaptmax1d,      typeid(torch::nn::AdaptiveMaxPool1d).hash_code(),       "torch.nn.AdaptiveMaxPool1d"),
  std::make_tuple(cs("adaptmax2d"),       Cast::adaptmax2d,      typeid(torch::nn::AdaptiveMaxPool2d).hash_code(),       "torch.nn.AdaptiveMaxPool2d"),
  std::make_tuple(cs("adaptmax3d"),       Cast::adaptmax3d,      typeid(torch::nn::AdaptiveMaxPool3d).hash_code(),       "torch.nn.AdaptiveMaxPool3d"),
  std::make_tuple(cs("adrop"),            Cast::adrop,           typeid(torch::nn::AlphaDropout).hash_code(),            "torch.nn.AlphaDropout"),
  std::make_tuple(cs("attention"),        Cast::attention,       typeid(torch::nn::MultiheadAttention).hash_code(),      "torch.nn.MultiheadAttention"),
  std::make_tuple(cs("avgpool1d"),        Cast::avgpool1d,       typeid(torch::nn::AvgPool1d).hash_code(),               "torch.nn.AvgPool1d"),
  std::make_tuple(cs("avgpool2d"),        Cast::avgpool2d,       typeid(torch::nn::AvgPool2d).hash_code(),               "torch.nn.AvgPool2d"),
  std::make_tuple(cs("avgpool3d"),        Cast::avgpool3d,       typeid(torch::nn::AvgPool3d).hash_code(),               "torch.nn.AvgPool3d"),
  std::make_tuple(cs("base"),             Cast::base,            typeid(torch::nn::Module).hash_code(),                  "torch.nn.Module"),
  std::make_tuple(cs("batchnorm1d"),      Cast::batchnorm1d,     typeid(torch::nn::BatchNorm1d).hash_code(),             "torch.nn.BatchNorm1d"),
  std::make_tuple(cs("batchnorm2d"),      Cast::batchnorm2d,     typeid(torch::nn::BatchNorm2d).hash_code(),             "torch.nn.BatchNorm2d"),
  std::make_tuple(cs("batchnorm3d"),      Cast::batchnorm3d,     typeid(torch::nn::BatchNorm3d).hash_code(),             "torch.nn.BatchNorm3d"),
  std::make_tuple(cs("bilinear"),         Cast::bilinear,        typeid(torch::nn::Bilinear).hash_code(),                "torch.nn.Bilinear"),
  std::make_tuple(cs("cat"),              Cast::cat,             typeid(Cat).hash_code(),                                "torch.cat"),
  std::make_tuple(cs("celu"),             Cast::celu,            typeid(torch::nn::CELU).hash_code(),                    "torch.nn.CELU"),
  std::make_tuple(cs("conv1d"),           Cast::conv1d,          typeid(torch::nn::Conv1d).hash_code(),                  "torch.nn.Conv1d"),
  std::make_tuple(cs("conv2d"),           Cast::conv2d,          typeid(torch::nn::Conv2d).hash_code(),                  "torch.nn.Conv2d"),
  std::make_tuple(cs("conv3d"),           Cast::conv3d,          typeid(torch::nn::Conv3d).hash_code(),                  "torch.nn.Conv3d"),
  std::make_tuple(cs("convtranspose1d"),  Cast::convtranspose1d, typeid(torch::nn::ConvTranspose1d).hash_code(),         "torch.nn.ConvTranspose1d"),
  std::make_tuple(cs("convtranspose2d"),  Cast::convtranspose2d, typeid(torch::nn::ConvTranspose2d).hash_code(),         "torch.nn.ConvTranspose2d"),
  std::make_tuple(cs("convtranspose3d"),  Cast::convtranspose3d, typeid(torch::nn::ConvTranspose3d).hash_code(),         "torch.nn.ConvTranspose3d"),
  std::make_tuple(cs("crossmap2d"),       Cast::crossmap2d,      typeid(torch::nn::CrossMapLRN2d).hash_code(),           "torch.nn.CrossMapLRN2d"),
  std::make_tuple(cs("decoder"),          Cast::decoder,         typeid(torch::nn::TransformerDecoder).hash_code(),      "torch.nn.TransformerDecoder"),
  std::make_tuple(cs("decoderlayer"),     Cast::decoderlayer,    typeid(torch::nn::TransformerDecoderLayer).hash_code(), "torch.nn.TransformerDecoderLayer"),
  std::make_tuple(cs("drop"),             Cast::drop,            typeid(torch::nn::Dropout).hash_code(),                 "torch.nn.Dropout"),
  std::make_tuple(cs("drop2d"),           Cast::drop2d,          typeid(torch::nn::Dropout2d).hash_code(),               "torch.nn.Dropout2d"),
  std::make_tuple(cs("drop3d"),           Cast::drop3d,          typeid(torch::nn::Dropout3d).hash_code(),               "torch.nn.Dropout3d"),
  std::make_tuple(cs("elu"),              Cast::elu,             typeid(torch::nn::ELU).hash_code(),                     "torch.nn.ELU"),
  std::make_tuple(cs("embed"),            Cast::embed,           typeid(torch::nn::Embedding).hash_code(),               "torch.nn.Embedding"),
  std::make_tuple(cs("embedbag"),         Cast::embedbag,        typeid(torch::nn::EmbeddingBag).hash_code(),            "torch.nn.EmbeddingBag"),
  std::make_tuple(cs("encoder"),          Cast::encoder,         typeid(torch::nn::TransformerEncoder).hash_code(),      "torch.nn.TransformerEncoder"),
  std::make_tuple(cs("encoderlayer"),     Cast::encoderlayer,    typeid(torch::nn::TransformerEncoderLayer).hash_code(), "torch.nn.TransformerEncoderLayer"),
  std::make_tuple(cs("expand"),           Cast::expand,          typeid(Expand).hash_code(),                             "torch.Tensor.expand"),
  std::make_tuple(cs("fadrop"),           Cast::fadrop,          typeid(torch::nn::FeatureAlphaDropout).hash_code(),     "torch.nn.FeatureAlphaDropout"),
  std::make_tuple(cs("flatten"),          Cast::flatten,         typeid(torch::nn::Flatten).hash_code(),                 "torch.nn.Flatten"),
  std::make_tuple(cs("fmaxpool2d"),       Cast::fmaxpool2d,      typeid(torch::nn::FractionalMaxPool2d).hash_code(),     "torch.nn.FractionalMaxPool2d"),
  std::make_tuple(cs("fmaxpool3d"),       Cast::fmaxpool3d,      typeid(torch::nn::FractionalMaxPool3d).hash_code(),     "torch.nn.FractionalMaxPool3d"),
  std::make_tuple(cs("fold"),             Cast::fold,            typeid(torch::nn::Fold).hash_code(),                    "torch.nn.Fold"),
  std::make_tuple(cs("gelu"),             Cast::gelu,            typeid(torch::nn::GELU).hash_code(),                    "torch.nn.GELU"),
  std::make_tuple(cs("glu"),              Cast::glu,             typeid(torch::nn::functional::glu).hash_code(),         "torch.nn.functional.glu"),
  std::make_tuple(cs("groupnorm"),        Cast::groupnorm,       typeid(torch::nn::GroupNorm).hash_code(),               "torch.nn.GroupNorm"),
  std::make_tuple(cs("gru"),              Cast::gru,             typeid(torch::nn::GRU).hash_code(),                     "torch.nn.GRU"),
  std::make_tuple(cs("hardshrink"),       Cast::hardshrink,      typeid(torch::nn::Hardshrink).hash_code(),              "torch.nn.Hardshrink"),
  std::make_tuple(cs("hardtanh"),         Cast::hardtanh,        typeid(torch::nn::Hardtanh).hash_code(),                "torch.nn.Hardtanh"),
  std::make_tuple(cs("identity"),         Cast::identity,        typeid(torch::nn::Identity).hash_code(),                "torch.nn.Identity"),
  std::make_tuple(cs("instancenorm1d"),   Cast::instancenorm1d,  typeid(torch::nn::InstanceNorm1d).hash_code(),          "torch.nn.InstanceNorm1d"),
  std::make_tuple(cs("instancenorm2d"),   Cast::instancenorm2d,  typeid(torch::nn::InstanceNorm2d).hash_code(),          "torch.nn.InstanceNorm2d"),
  std::make_tuple(cs("instancenorm3d"),   Cast::instancenorm3d,  typeid(torch::nn::InstanceNorm3d).hash_code(),          "torch.nn.InstanceNorm3d"),
  ...
  std::make_tuple(cs("layernorm"),        Cast::layernorm,       typeid(torch::nn::LayerNorm).hash_code(),               "torch.nn.LayerNorm"),
  std::make_tuple(cs("leakyrelu"),        Cast::leakyrelu,       typeid(torch::nn::LeakyReLU).hash_code(),               "torch.nn.LeakyReLU"),
  std::make_tuple(cs("linear"),           Cast::linear,          typeid(torch::nn::Linear).hash_code(),                  "torch.nn.Linear"),
  std::make_tuple(cs("localnorm"),        Cast::localnorm,       typeid(torch::nn::LocalResponseNorm).hash_code(),       "torch.nn.LocalResponseNorm"),
  std::make_tuple(cs("logsigmoid"),       Cast::logsigmoid,      typeid(torch::nn::LogSigmoid).hash_code(),              "torch.nn.LogSigmoid"),
  std::make_tuple(cs("logsoftmax"),       Cast::logsoftmax,      typeid(torch::nn::LogSoftmax).hash_code(),              "torch.nn.LogSoftmax"),
  std::make_tuple(cs("lppool1d"),         Cast::lppool1d,        typeid(torch::nn::LPPool1d).hash_code(),                "torch.nn.LPPool1d"),
  std::make_tuple(cs("lppool2d"),         Cast::lppool2d,        typeid(torch::nn::LPPool2d).hash_code(),                "torch.nn.LPPool2d"),
  std::make_tuple(cs("lstm"),             Cast::lstm,            typeid(torch::nn::LSTM).hash_code(),                    "torch.nn.LSTM"),
  std::make_tuple(cs("maxpool1d"),        Cast::maxpool1d,       typeid(torch::nn::MaxPool1d).hash_code(),               "torch.nn.MaxPool1d"),
  std::make_tuple(cs("maxpool2d"),        Cast::maxpool2d,       typeid(torch::nn::MaxPool2d).hash_code(),               "torch.nn.MaxPool2d"),
  std::make_tuple(cs("maxpool3d"),        Cast::maxpool3d,       typeid(torch::nn::MaxPool3d).hash_code(),               "torch.nn.MaxPool3d"),
  std::make_tuple(cs("modulelist"),       Cast::modulelist,      typeid(torch::nn::ModuleList).hash_code(),              "torch.nn.ModuleList"),
  std::make_tuple(cs("mul"),              Cast::mul,             typeid(Mul).hash_code(),                                "torch.mul"),
  std::make_tuple(cs("normalize"),        Cast::normalize,       typeid(torch::nn::functional::normalize).hash_code(),   "torch.nn.functional.normalize"),
  std::make_tuple(cs("pad"),              Cast::pad,             typeid(Pad).hash_code(),                                "torch.nn.functional.pad"),
  std::make_tuple(cs("pad1d"),            Cast::pad1d,           typeid(torch::nn::ConstantPad1d).hash_code(),           "torch.nn.ConstantPad1d"),
  std::make_tuple(cs("pad2d"),            Cast::pad2d,           typeid(torch::nn::ConstantPad2d).hash_code(),           "torch.nn.ConstantPad2d"),
  std::make_tuple(cs("pad3d"),            Cast::pad3d,           typeid(torch::nn::ConstantPad3d).hash_code(),           "torch.nn.ConstantPad3d"),
  std::make_tuple(cs("pairwise"),         Cast::pairwise,        typeid(torch::nn::PairwiseDistance).hash_code(),        "torch.nn.PairwiseDistance"),
  std::make_tuple(cs("prelu"),            Cast::prelu,           typeid(torch::nn::PReLU).hash_code(),                   "torch.nn.PReLU"),
  std::make_tuple(cs("reflect1d"),        Cast::reflect1d,       typeid(torch::nn::ReflectionPad1d).hash_code(),         "torch.nn.ReflectionPad1d"),
  std::make_tuple(cs("reflect2d"),        Cast::reflect2d,       typeid(torch::nn::ReflectionPad2d).hash_code(),         "torch.nn.ReflectionPad2d"),
  std::make_tuple(cs("relu"),             Cast::relu,            typeid(torch::nn::ReLU).hash_code(),                    "torch.nn.ReLU"),
  std::make_tuple(cs("relu6"),            Cast::relu6,           typeid(torch::nn::ReLU6).hash_code(),                   "torch.nn.ReLU6"),
  std::make_tuple(cs("replicate1d"),      Cast::replicate1d,     typeid(torch::nn::ReplicationPad1d).hash_code(),        "torch.nn.ReplicationPad1d"),
  std::make_tuple(cs("replicate2d"),      Cast::replicate2d,     typeid(torch::nn::ReplicationPad2d).hash_code(),        "torch.nn.ReplicationPad2d"),
  std::make_tuple(cs("replicate3d"),      Cast::replicate3d,     typeid(torch::nn::ReplicationPad3d).hash_code(),        "torch.nn.ReplicationPad3d"),
  std::make_tuple(cs("reshape"),          Cast::reshape,         typeid(Reshape).hash_code(),                            "torch.reshape"),
  std::make_tuple(cs("rnn"),              Cast::rnn,             typeid(torch::nn::RNN).hash_code(),                     "torch.nn.RNN"),
  std::make_tuple(cs("rrelu"),            Cast::rrelu,           typeid(torch::nn::RReLU).hash_code(),                   "torch.nn.RReLU"),
  std::make_tuple(cs("selu"),             Cast::selu,            typeid(torch::nn::SELU).hash_code(),                    "torch.nn.SELU"),
  std::make_tuple(cs("seqjoin"),          Cast::seqjoin,         typeid(SeqJoin).hash_code(),                            ""),
  std::make_tuple(cs("seqnest"),          Cast::seqnest,         typeid(SeqNest).hash_code(),                            ""),
  std::make_tuple(cs("sequential"),       Cast::sequential,      typeid(torch::nn::Sequential).hash_code(),              "torch.nn.Sequential"),
  std::make_tuple(cs("sigmoid"),          Cast::sigmoid,         typeid(torch::nn::Sigmoid).hash_code(),                 "torch.nn.Sigmoid"),
  std::make_tuple(cs("similar"),          Cast::similar,         typeid(torch::nn::CosineSimilarity).hash_code(),        "torch.nn.CosineSimilarity"),
  std::make_tuple(cs("softmax"),          Cast::softmax,         typeid(torch::nn::Softmax).hash_code(),                 "torch.nn.Softmax"),
  std::make_tuple(cs("softmax2d"),        Cast::softmax2d,       typeid(torch::nn::Softmax2d).hash_code(),               "torch.nn.Softmax2d"),
  std::make_tuple(cs("softmin"),          Cast::softmin,         typeid(torch::nn::Softmin).hash_code(),                 "torch.nn.Softmin"),
  std::make_tuple(cs("softplus"),         Cast::softplus,        typeid(torch::nn::Softplus).hash_code(),                "torch.nn.Softplus"),
  std::make_tuple(cs("softshrink"),       Cast::softshrink,      typeid(torch::nn::Softshrink).hash_code(),              "torch.nn.Softshrink"),
  std::make_tuple(cs("softsign"),         Cast::softsign,        typeid(torch::nn::Softsign).hash_code(),                "torch.nn.Softsign"),
  std::make_tuple(cs("squeeze"),          Cast::squeeze,         typeid(Squeeze).hash_code(),                            "torch.squeeze"),
  std::make_tuple(cs("tanh"),             Cast::tanh,            typeid(torch::nn::Tanh).hash_code(),                    "torch.nn.Tanh"),
  std::make_tuple(cs("tanhshrink"),       Cast::tanhshrink,      typeid(torch::nn::Tanhshrink).hash_code(),              "torch.nn.Tanhshrink"),
  std::make_tuple(cs("threshold"),        Cast::threshold,       typeid(torch::nn::Threshold).hash_code(),               "torch.nn.Threshold"),
  std::make_tuple(cs("transformer"),      Cast::transformer,     typeid(torch::nn::Transformer).hash_code(),             "torch.nn.Transformer"),
  std::make_tuple(cs("unfold"),           Cast::unfold,          typeid(torch::nn::Unfold).hash_code(),                  "torch.nn.Unfold"),
  std::make_tuple(cs("unsqueeze"),        Cast::unsqueeze,       typeid(Unsqueeze).hash_code(),                          "torch.unsqueeze"),
  std::make_tuple(cs("upsample"),         Cast::upsample,        typeid(torch::nn::Upsample).hash_code(),                "torch.nn.Upsample"),
  std::make_tuple(cs("zeropad2d"),        Cast::zeropad2d,       typeid(torch::nn::ZeroPad2d).hash_code(),               "torch.nn.ZeroPad2d")
 }};
