...
*/
 ...
 std::array<std::tuple<S,Cast,std::string>,103> module = {{               // module sym -> enum, pytorch name
  ...
  std::make_tuple(cs("adaptmax1d"),      Cast::adaptmax1d,       "torch.nn.AdaptiveMaxPool1d"),
  std::make_tuple(cs("adaptmax2d"),      Cast::adaptmax2d,       "torch.nn.AdaptiveMaxPool2d"),
  std::make_tuple(cs("adaptmax3d"),      Cast::adaptmax3d,       "torch.nn.AdaptiveMaxPool3d"),
  std::make_tuple(cs("adrop"),           Cast::adrop,            "torch.nn.AlphaDropout"),
  std::make_tuple(cs("attention"),       Cast::attention,        "torch.nn.MultiheadAttention"),
  ...
  std::make_tuple(cs("bilinear"),        Cast::bilinear,         "torch.nn.Bilinear"),
  std::make_tuple(cs("cat"),             Cast::cat,              "torch.cat"),
  std::make_tuple(cs("celu"),            Cast::celu,             "torch.nn.CELU"),
  std::make_tuple(cs("conv1d"),          Cast::conv1d,           "torch.nn.Conv1d"),
  std::make_tuple(cs("conv2d"),          Cast::conv2d,           "torch.nn.Conv2d"),
  std::make_tuple(cs("conv3d"),          Cast::conv3d,           "torch.nn.Conv3d"),
  std::make_tuple(cs("convtranspose1d"), Cast::convtranspose1d,  "torch.nn.ConvTranspose1d"),
  std::make_tuple(cs("convtranspose2d"), Cast::convtranspose2d,  "torch.nn.ConvTranspose2d"),
  std::make_tuple(cs("convtranspose3d"), Cast::convtranspose3d,  "torch.nn.ConvTranspose3d"),
  std::make_tuple(cs("crossmap2d"),      Cast::crossmap2d,       "torch.nn.CrossMapLRN2d"),
  std::make_tuple(cs("decoder"),         Cast::decoder,          "torch.nn.TransformerDecoder"),
  std::make_tuple(cs("decoderlayer"),    Cast::decoderlayer,     "torch.nn.TransformerDecoderLayer"),
  std::make_tuple(cs("drop"),            Cast::drop,             "torch.nn.Dropout"),
  std::make_tuple(cs("drop2d"),          Cast::drop2d,           "torch.nn.Dropout2d"),
  std::make_tuple(cs("drop3d"),          Cast::drop3d,           "torch.nn.Dropout3d"),
  std::make_tuple(cs("elu"),             Cast::elu,              "torch.nn.ELU"),
  std::make_tuple(cs("embed"),           Cast::embed,            "torch.nn.Embedding"),
  std::make_tuple(cs("embedbag"),        Cast::embedbag,         "torch.nn.EmbeddingBag"),
  std::make_tuple(cs("encoder"),         Cast::encoder,          "torch.nn.TransformerEncoder"),
  std::make_tuple(cs("encoderlayer"),    Cast::encoderlayer,     "torch.nn.TransformerEncoderLayer"),
  std::make_tuple(cs("expand"),          Cast::expand,           "torch.Tensor.expand"),
  std::make_tuple(cs("fadrop"),          Cast::fadrop,           "torch.nn.FeatureAlphaDropout"),
  std::make_tuple(cs("flatten"),         Cast::flatten,          "torch.nn.Flatten"),
  std::make_tuple(cs("fmaxpool2d"),      Cast::fmaxpool2d,       "torch.nn.FractionalMaxPool2d"),
  std::make_tuple(cs("fmaxpool3d"),      Cast::fmaxpool3d,       "torch.nn.FractionalMaxPool3d"),
  std::make_tuple(cs("fold"),            Cast::fold,             "torch.nn.Fold"),
  std::make_tuple(cs("gelu"),            Cast::gelu,             "torch.nn.GELU"),
  std::make_tuple(cs("glu"),             Cast::glu,              "torch.nn.functional.glu"),
  std::make_tuple(cs("groupnorm"),       Cast::groupnorm,        "torch.nn.GroupNorm"),
  std::make_tuple(cs("gru"),             Cast::gru,              "torch.nn.GRU"),
  std::make_tuple(cs("hardshrink"),      Cast::hardshrink,       "torch.nn.Hardshrink"),
  std::make_tuple(cs("hardtanh"),        Cast::hardtanh,         "torch.nn.Hardtanh"),
  std::make_tuple(cs("identity"),        Cast::identity,         "torch.nn.Identity"),
  std::make_tuple(cs("instancenorm1d"),  Cast::instancenorm1d,   "torch.nn.InstanceNorm1d"),
  std::make_tuple(cs("instancenorm2d"),  Cast::instancenorm2d,   "torch.nn.InstanceNorm2d"),
  std::make_tuple(cs("instancenorm3d"),  Cast::instancenorm3d,   "torch.nn.InstanceNorm3d"),
  std::make_tuple(cs("interpolate"),     Cast::interpolate,      "torch.nn.functional.interpolate"),
  std::make_tuple(cs("layernorm"),       Cast::layernorm,        "torch.nn.LayerNorm"),
  std::make_tuple(cs("leakyrelu"),       Cast::leakyrelu,        "torch.nn.LeakyReLU"),
  std::make_tuple(cs("linear"),          Cast::linear,           "torch.nn.Linear"),
  std::make_tuple(cs("localnorm"),       Cast::localnorm,        "torch.nn.LocalResponseNorm"),
  std::make_tuple(cs("logsigmoid"),      Cast::logsigmoid,       "torch.nn.LogSigmoid"),
  std::make_tuple(cs("logsoftmax"),      Cast::logsoftmax,       "torch.nn.LogSoftmax"),
  std::make_tuple(cs("lppool1d"),        Cast::lppool1d,         "torch.nn.LPPool1d"),
  std::make_tuple(cs("lppool2d"),        Cast::lppool2d,         "torch.nn.LPPool2d"),
  std::make_tuple(cs("lstm"),            Cast::lstm,             "torch.nn.LSTM"),
  std::make_tuple(cs("maxpool1d"),       Cast::maxpool1d,        "torch.nn.MaxPool1d"),
  std::make_tuple(cs("maxpool2d"),       Cast::maxpool2d,        "torch.nn.MaxPool2d"),
  std::make_tuple(cs("maxpool3d"),       Cast::maxpool3d,        "torch.nn.MaxPool3d"),
  std::make_tuple(cs("modulelist"),      Cast::modulelist,       "torch.nn.ModuleList"),
  std::make_tuple(cs("mul"),             Cast::mul,              "torch.mul"),
  std::make_tuple(cs("normalize"),       Cast::normalize,        "torch.nn.NormalizeFunc"),
  std::make_tuple(cs("pad"),             Cast::pad,              "torch.nn.PadFunc"),
  std::make_tuple(cs("pad1d"),           Cast::pad1d,            "torch.nn.ConstantPad1d"),
  std::make_tuple(cs("pad2d"),           Cast::pad2d,            "torch.nn.ConstantPad2d"),
  std::make_tuple(cs("pad3d"),           Cast::pad3d,            "torch.nn.ConstantPad3d"),
  std::make_tuple(cs("pairwise"),        Cast::pairwise,         "torch.nn.PairwiseDistance"),
  std::make_tuple(cs("prelu"),           Cast::prelu,            "torch.nn.PReLU"),
  std::make_tuple(cs("reflect1d"),       Cast::reflect1d,        "torch.nn.ReflectionPad1d"),
  std::make_tuple(cs("reflect2d"),       Cast::reflect2d,        "torch.nn.ReflectionPad2d"),
  std::make_tuple(cs("relu"),            Cast::relu,             "torch.nn.ReLU"),
  std::make_tuple(cs("relu6"),           Cast::relu6,            "torch.nn.ReLU6"),
  std::make_tuple(cs("replicate1d"),     Cast::replicate1d,      "torch.nn.ReplicationPad1d"),
  std::make_tuple(cs("replicate2d"),     Cast::replicate2d,      "torch.nn.ReplicationPad2d"),
  std::make_tuple(cs("replicate3d"),     Cast::replicate3d,      "torch.nn.ReplicationPad3d"),
  std::make_tuple(cs("reshape"),         Cast::reshape,          "torch.reshape"),
  std::make_tuple(cs("rnn"),             Cast::rnn,              "torch.nn.RNN"),
  std::make_tuple(cs("rrelu"),           Cast::rrelu,            "torch.nn.RReLU"),
  std::make_tuple(cs("selu"),            Cast::selu,             "torch.nn.SELU"),
  std::make_tuple(cs("seqjoin"),         Cast::seqjoin,          ""),
  std::make_tuple(cs("seqnest"),         Cast::seqnest,          ""),
  std::make_tuple(cs("sequential"),      Cast::sequential,       "torch.nn.Sequential"),
  std::make_tuple(cs("sigmoid"),         Cast::sigmoid,          "torch.nn.Sigmoid"),
  std::make_tuple(cs("similar"),         Cast::similar,          "torch.nn.CosineSimilarity"),
  std::make_tuple(cs("softmax"),         Cast::softmax,          "torch.nn.Softmax"),
  std::make_tuple(cs("softmax2d"),       Cast::softmax2d,        "torch.nn.Softmax2d"),
  std::make_tuple(cs("softmin"),         Cast::softmin,          "torch.nn.Softmin"),
  std::make_tuple(cs("softplus"),        Cast::softplus,         "torch.nn.Softplus"),
  std::make_tuple(cs("softshrink"),      Cast::softshrink,       "torch.nn.Softshrink"),
  std::make_tuple(cs("softsign"),        Cast::softsign,         "torch.nn.Softsign"),
  std::make_tuple(cs("squeeze"),         Cast::squeeze,          "torch.squeeze"),
  std::make_tuple(cs("tanh"),            Cast::tanh,             "torch.nn.Tanh"),
  std::make_tuple(cs("tanhshrink"),      Cast::tanhshrink,       "torch.nn.Tanhshrink"),
  std::make_tuple(cs("threshold"),       Cast::threshold,        "torch.nn.Threshold"),
  std::make_tuple(cs("transformer"),     Cast::transformer,      "torch.nn.Transformer"),
  std::make_tuple(cs("unfold"),          Cast::unfold,           "torch.nn.Unfold"),
  std::make_tuple(cs("unsqueeze"),       Cast::unsqueeze,        "torch.unsqueeze"),
  std::make_tuple(cs("upsample"),        Cast::upsample,         "torch.nn.Upsample"),
  std::make_tuple(cs("zeropad2d"),       Cast::zeropad2d,        "torch.nn.ZeroPad2d"),
 }};
